...
class ConditionalVMC(AbstractVariationalDriver):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._conditionTable = conditionTable;
        """
    ...
    def _forward_and_backward(self):
        ...
        self._dp = jax.tree_multimap(lambda x,y: x*y, self._dp, self._conditionTable)
